...
# Generated by qmake (2.01a) (Qt 4.3.4) on: ?? ???? 19 15:44:20 2008
# Project:  Cuberok.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) unix/obj/cuberok1.0.0/ && $(COPY_FILE) --parents aboutdialog.h collectionview.h cuberok.h database.h lookandfeel.h main.h playerthread.h playlistcontainer.h playlistmodel.h playlistview.h tageditor.h tagger.h unix/obj/cuberok1.0.0/ && $(COPY_FILE) --parents resource.qrc unix/obj/cuberok1.0.0/ && $(COPY_FILE) --parents aboutdialog.cpp collectionview.cpp cuberok.cpp database.cpp lookandfeel.cpp main.cpp playerthread.cpp playlistcontainer.cpp playlistmodel.cpp playlistview.cpp tageditor.cpp tagger.cpp unix/obj/cuberok1.0.0/ && $(COPY_FILE) --parents aboutdialog.ui collectionview.ui cuberok.ui lookandfeel.ui tageditor.ui unix/obj/cuberok1.0.0/ && (cd `dirname unix/obj/cuberok1.0.0` && $(TAR) cuberok1.0.0.tar cuberok1.0.0 && $(COMPRESS) cuberok1.0.0.tar) && $(MOVE) `dirname unix/obj/cuberok1.0.0`/cuberok1.0.0.tar.gz . && $(DEL_FILE) -r unix/obj/cuberok1.0.0
...
compiler_moc_header_make_all: unix/obj/moc_aboutdialog.cpp unix/obj/moc_collectionview.cpp unix/obj/moc_cuberok.cpp unix/obj/moc_lookandfeel.cpp unix/obj/moc_playerthread.cpp unix/obj/moc_playlistcontainer.cpp unix/obj/moc_playlistmodel.cpp unix/obj/moc_playlistview.cpp unix/obj/moc_tageditor.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) unix/obj/moc_aboutdialog.cpp unix/obj/moc_collectionview.cpp unix/obj/moc_cuberok.cpp unix/obj/moc_lookandfeel.cpp unix/obj/moc_playerthread.cpp unix/obj/moc_playlistcontainer.cpp unix/obj/moc_playlistmodel.cpp unix/obj/moc_playlistview.cpp unix/obj/moc_tageditor.cpp
...
unix/obj/moc_playerthread.cpp: playerthread.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) playerthread.h -o unix/obj/moc_playerthread.cpp
...
unix/obj/playerthread.o: playerthread.cpp playerthread.h \
		main.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o unix/obj/playerthread.o playerthread.cpp
...
unix/obj/moc_playerthread.o: unix/obj/moc_playerthread.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o unix/obj/moc_playerthread.o unix/obj/moc_playerthread.cpp
