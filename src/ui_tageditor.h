...
**
** Created: Tue 10. Mar 11:21:44 2009
...
public:
    ...
    void setupUi(QDialog *TagEditorClass)
    {
        ...
        TagEditorClass->setWindowIcon(icon);
        ...
        QIcon icon1;
        icon1.addPixmap(QPixmap(QString::fromUtf8(":/icons/ban.png")), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addPixmap(QPixmap(QString::fromUtf8(":/icons/save.png")), QIcon::Normal, QIcon::Off);
        ...
        QWidget::setTabOrder(lineTitle, lineArtist);
        QWidget::setTabOrder(lineArtist, lineAlbum);
        QWidget::setTabOrder(lineAlbum, comboBox_Genre);
        QWidget::setTabOrder(comboBox_Genre, spinBox_Track);
        QWidget::setTabOrder(spinBox_Track, spinBox_Year);
        QWidget::setTabOrder(spinBox_Year, spinBox_Rating);
        QWidget::setTabOrder(spinBox_Rating, lineComment);
        QWidget::setTabOrder(lineComment, pushButton_Cancel);
        QWidget::setTabOrder(pushButton_Cancel, pushButton_Save);
        QWidget::setTabOrder(pushButton_Save, pushButton_Correct);
        QWidget::setTabOrder(pushButton_Correct, pushButton_Correct2);
        QWidget::setTabOrder(pushButton_Correct2, label);
    ...
    void retranslateUi(QDialog *TagEditorClass)
    {
        ...
        pushButton_Correct->setText(QApplication::translate("TagEditorClass", "Correct 8bit locale", 0, QApplication::UnicodeUTF8));
        pushButton_Correct2->setText(QApplication::translate("TagEditorClass", "Correct broken UTF", 0, QApplication::UnicodeUTF8));
